...
class GameItem extends React.Component {
  ...
  render(){
    ...
    return(
      <div id="list-item">
        <p className="names">Name: {this.props.game.title}</p>
        <div className="deets">
          {gamePlayerNodes}
        </div>
        <button className="button" onClick={() => {this.deleteSelectedGame(this.props.game.id)}} >Delete</button>
